...
export default function App() {
    ...
    const notifyClick = () => {
        ...
        console.log(`[${dateStr}] Clicou no balão de atendimento! (${
            ...
            <header className="sticky top-0 z-50 bg-cream/90 backdrop-blur-md border-b border-coral-200/20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex items-center gap-8 text-xs font-semibold uppercase tracking-wider text-charcoal-700">
                        ...
                        <a href="#servicos" className="hover:text-coral-600 transition-colors">
                            Especialidades
                        </a>
                    ...
                    <MousePointerClick size={16} className="text-coral-500" />
                            ...
                            <div className="lg:col-span-5 flex flex-col items-center justify-center order-1 lg:order-2">
                                ...
                                <div className="relative w-full max-w-sm">
                                    {/* Decorative Frame */}
                                    <div className="absolute inset-0 bg-coral-200 border border-coral-300 rounded-3xl translate-x-3 translate-y-3 -z-10"/> {/* Actual Photo */}
                                    <div className="rounded-3xl overflow-hidden border-2 border-white shadow-xl bg-slate-100 aspect-3/4">
                                        <img id="therapist-portrait" src="psicologa.jpeg" alt="Flávia Elizabeth Oliva de Morais - Psicóloga Perinatal" className="w-full h-full object-cover select-none scale-102 hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer"/>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 text-left mb-12">
                        ...
                        <div className="space-y-3 font-sans text-xs text-charcoal-400">
                            ...
                            <ul className="space-y-2">
                                <li>
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone=5515988096168&text=Quero%20agendar%20uma%20consulta" target="_blank" rel="noreferrer" className="hover:text-coral-400 underline font-medium block">
                                        (15) 98809-6168
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-2 uppercase text-[10px] tracking-widest font-bold">
                                <li>
                                    <a href="#sobre" className="hover:text-coral-500 transition-colors">
                                        Sobre Mim
                                    </a>
                                </li>
                                <li>
                                    <a href="#servicos" className="hover:text-coral-500 transition-colors">
                                        Especialidades
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#faq" className="hover:text-coral-500 transition-colors">
                                        Dúvidas Comuns
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="pt-2 flex gap-3 text-coral-500 font-medium">
                                <a href="https://site.cfp.org.br" target="_blank" rel="noreferrer" className="hover:underline">
                                    CFP Oficial
                                </a>
                                <a href="https://e-psi.cfp.org.br" target="_blank" rel="noreferrer" className="hover:underline">
                                    Conselho e-Psi
                                </a>
                            </div>
                        </div>
